...
function buildV0Url(url: string, title?: string, prompt?: string) {
...
export function OpenInV0Button({
  ...
  return (
    <Button aria-label="Open in v0" size="sm" className={cn("dark:text-dark-slate-50 bg-blue-600 text-white shadow-none hover:bg-blue-700 dark:bg-blue-300 dark:hover:bg-blue-200", className)} asChild>
