...
import { Button, buttonVariants } from "@/registry/ads/ui/button";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(buttonVariants({ appearance: buttonAppearance }), "size-(--cell-size) p-0 select-none aria-disabled:opacity-50", defaultClassNames.button_previous),
        button_next: cn(buttonVariants({ appearance: buttonAppearance }), "size-(--cell-size) p-0 select-none aria-disabled:opacity-50", defaultClassNames.button_next),
        ...
        caption_label: cn(
          ...
          captionLayout === "label" ? "text-sm" : "[&>svg]:text-muted-foreground flex h-8 items-center gap-1 rounded-md pr-1 pl-2 text-sm [&>svg]:size-3.5",
