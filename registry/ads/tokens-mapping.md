...
| `background.disabled`                        | #17171708   | #01040475  | neutral100a      | darkneutralminus100a | `bg-slate-50a`         | `dark:bg-dark-slate-minus-50a`   | Use for backgrounds of elements in a disabled state.                                                                                    |
